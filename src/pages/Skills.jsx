...
const SkillsPage = () => {
    return (
        ...
        content="J'ai pu concevoir des sites web en partant de zéro tout en prenant soin d'adapter la sémantique HTML5 et en faisant attention de respecter au maximum les normes W3C.
        <br/><br/>
